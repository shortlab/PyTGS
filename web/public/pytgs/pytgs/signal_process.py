...
from pytgs.io import read_data
...
def process_signal(pos_file: str, neg_file: str, grating_spacing: float, heterodyne: str = 'di-homodyne', null_point: int = 2, initial_samples: int = 50, baseline_correction: dict = None) -> Tuple[np.ndarray, float, int, float]:
    """
