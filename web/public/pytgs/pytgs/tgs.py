...
from pytgs.fft import fft
from pytgs.lorentzian import lorentzian_fit
from pytgs.functions import tgs_function

def tgs_fit(config: dict, pos_file: str, neg_file: str, grating_spacing: float, signal_proportion: float = 0.9, maxfev: int = 1000000) -> Tuple[Union[float, np.ndarray]]:
    """
    ...
    signal, max_time, start_time, start_idx = process_signal(
        pos_file, neg_file, grating_spacing,
